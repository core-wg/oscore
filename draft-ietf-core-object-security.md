...
Non-Observe responses with or without Partial IV are protected against replay as they are bound to the request. The Partial IV in a non-Observe response is not used for replay protection.
